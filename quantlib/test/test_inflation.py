...
#TODO: old test works this does not.
...
from quantlib.time.businessdayconvention import \
        (ModifiedFollowing)
from quantlib.time.api import Thirty360
...
from quantlib.termstructures.inflation.inflation_helpers import ZeroCouponInflationSwapHelper
...
class InflationIndexTestCase(unittest.TestCase):
    ...
    #     from_date = Date(1, January, 2005)
    #     to_date = Date(13, August, 2007)
    #     rpi_schedule = Schedule.from_rule(from_date,
    #         to_date,
    #         Period(1, Months),
    #         calendar,
    #         bdc)
